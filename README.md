...
|`<foaf:Person>`|`<foaf:Person>`**REQUIRED** - container element with information about the author. One or more authors reside within the <cal:authors> container.</br> Element `<foaf:name>` **OPTIONAL**
