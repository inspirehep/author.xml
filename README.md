...
### Downloads
 ...
 - [.zip file](https://github.com/inspirehep/author.xml/blob/abchan-paragraph/downloads/authors_xml.zip) - includes the template, an example and a .dtd file for validation
